...
const PLAIN: Record<string, string> = {
  ...
  SessionHandler_SessionKeyIsOwner: "Your own address can't be the assistant's key.",
  SessionHandler_SessionExpiryInPast: 'That end date has already passed.',
  SessionHandler_SessionTtlTooLong: "The assistant's access can last at most 90 days.",
